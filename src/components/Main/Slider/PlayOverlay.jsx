    ...
    <>
      ...
      <div className="fixed z-30 my-[172px] mx-[5px] h-auto md:h-[617px] min-w-[350px] bg-white p-[15px] md:mx-auto md:w-[70%] md:max-w-[1310px] md:p-[30px]">
        ...
        {/* <img
          ...
          height={505}
        /> */}
        <iframe width="100%" height="89%" src="https://www.youtube.com/embed/utOU0sNkRjY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
    </>
  );
}
